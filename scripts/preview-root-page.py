...
def build_preview_html() -> str:
    ...
    config_html = "\n".join(
        [
            f'          <div class="config-row"><div class="config-label"><span data-filter-label-enabled>Media type filtering enabled</span><span data-filter-label-disabled style="display:none">Media type filtering disabled</span></div><div class="config-value"><label class="config-toggle"><input type="checkbox" data-config-enabled checked /><span class="config-toggle__track" aria-hidden="true"><span class="config-toggle__thumb"></span></span></label></div></div>',
            f'          <div class="config-row"><div class="config-label">Limit the number of releases</div><div class="config-value"><span class="config-value-text">no limit</span><button class="config-action" type="button" aria-label="More" data-config-menu><span class="config-action__inner">{menu_icon}</span></button></div></div>',
            f'          <div class="config-row"><div class="config-label">(Optional) Preferred media type when limiting</div><div class="config-value"><span class="config-value-text">digital</span><button class="config-action" type="button" aria-label="More" data-config-menu><span class="config-action__inner">{menu_icon}</span></button></div></div>',
            f'          <div class="config-row"><div class="config-label">Filtered</div><div class="config-value"><span class="config-value-text">vinyl, cassette</span><button class="config-action" type="button" aria-label="More" data-config-menu><span class="config-action__inner">{menu_icon}</span></button></div></div>',
    ...
    replacements = {
        ...
        "__LIMBO_APIKEY__": "",
        "__LIMBO_URL__": "http://limbo-ip:5001",
        "__LIMBO_URL_REFERRER__": "http://limbo-ip:5001",
        "__LIMBO_URL_HOST__": "http://192.168.1.44:5001",
        "__LIMBO_URL_MODE__": "auto-referrer",
        "__LIMBO_URL_CUSTOM__": "",
        "__FANART_KEY__": "",
        "__TADB_KEY__": "",
        "__LASTFM_KEY__": "",
        "__LASTFM_SECRET__": "",
        "__TIDAL_CLIENT_ID__": "",
        "__TIDAL_CLIENT_SECRET__": "",
        "__TIDAL_COUNTRY_CODE__": "",
        "__TIDAL_USER__": "",
        "__TIDAL_USER_PASSWORD__": "",
        "__DISCOGS_KEY__": "",
        "__FANART_ENABLED__": "false",
        "__TADB_ENABLED__": "false",
        ...
        "__MUSICBRAINZ_ENABLED__": "true",
        "__WIKIPEDIA_ENABLED__": "true",
        "__COVERART_ENABLED__": "true",
        ...
        "__WIKIPEDIA_UI_URL__": "https://www.wikipedia.org/",
